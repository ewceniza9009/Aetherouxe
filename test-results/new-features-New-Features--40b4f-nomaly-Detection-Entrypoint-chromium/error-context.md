...
- Name: new-features.spec.ts >> New Features E2E Verification Suite >> 4. Field Meter Reader & Anomaly Detection Entrypoint
- Location: e2e\new-features.spec.ts:64:7
...
Call log:
  - waiting for locator('h1:has-text("Field Meter Reader")') to be visible
