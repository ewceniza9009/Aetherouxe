...
- Name: new-features.spec.ts >> New Features E2E Verification Suite >> 2. Maintenance Ticket Kanban & Vendor Dispatch Flow
...
Call log:
  - waiting for locator('h1:has-text("Maintenance Kanban")') to be visible
