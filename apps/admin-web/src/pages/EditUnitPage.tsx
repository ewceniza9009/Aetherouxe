  ...
  if (!unit) {
    return (
      <div className="space-y-6">
        ...
        <p className="text-red-500">Unit not found.</p>
      </div>
    );
  }
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            {property ? `${property.name} - Unit ${unit.unitNumber}` : "Edit unit"}
          </p>
        </div>
      </div>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="grid grid-cols-3 gap-4">
              <div className="space-y-2">
                ...
                <Input type="number" min="0" value={form.size} onChange={(e) => setForm((p) => ({ ...p, size: e.target.value }))} />
              </div>
              <div className="space-y-2">
