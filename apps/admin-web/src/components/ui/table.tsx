...
>(({ className, scroll = true, ...props }, ref) => (
  <div className={cn("relative w-full", scroll ? "scroll-grid" : "overflow-auto")}>
    <table
      ref={ref}
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-11 px-4 text-left align-middle text-xs uppercase tracking-wider font-semibold text-muted-foreground [&:has([role=checkbox])]:pr-0",
      className
    )}
    {...props}
  />
