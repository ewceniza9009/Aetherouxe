...
export function EmptyState({
  ...
  return (
    <div
      className={cn(
        'empty-state-container relative flex flex-1 flex-col items-center justify-center min-h-[200px] w-full h-full p-8 text-center overflow-hidden',
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center justify-center">
        ...
        <h3 className="text-2xl font-bold tracking-tight mb-3 text-foreground/90">{title}</h3>
